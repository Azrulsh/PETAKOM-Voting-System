...
class WelfareExcoController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        foreach ($request->input('rate') as $criteriaId => $rateValueInput) {
            ...
            $candidateWelfareExco = WelfareExco::where('id', $criteriaId)->value('candidate_name');
                ...
                if ($voterName == null) {
                    ...
                    if ($candidateWelfareExco == null) {
                        ...
                        if ($request->input('candidate_name.' . $criteriaId) == $candidateName) {
                            ...
                            $existingRecord = WelfareExco::where('candidate_name', $request->input('candidate_name.' . $criteriaId))
